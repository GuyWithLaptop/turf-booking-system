...
export default function UpdateExpense({ expenseId }: { expenseId: string }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-bold">Update Expense</h1>
          </div>
          <button
      ...
      {/* Form */}
      <div className="p-4">
        <form onSubmit={handleUpdate} className="bg-white rounded-2xl p-6 space-y-6">
          {/* Category */}
          <div>
